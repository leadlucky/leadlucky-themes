<template>
    <div>
      ...
      <header id="header">
        ...
        <div  class="logo"><a href="#">{{customData.title}}<span>{{customData.description}}</span></a></div>
      </header>
        ...
        <div class="inner">
          ...
          <section id="one" class="wrapper style1">
            ...
            <header class="special">
              ...
              <p >{{customData.subheader}}</p>
            </header>
            <div class="content">
              <v-flex xs4 offset-xs4>
              <v-form v-model="valid">
                <v-flex xs12 class="text-xs-center">
                  <h4 >{{customData.emailheader}}</h4>
                  <v-text-field solo placeholder="example@mysite.com" class="theme--light" v-model="theEmail" :rules="emailRules" style="color: green"></v-text-field>
                </v-flex>
                <p class="text-xs-left" v-text="errorText" style="color: red"></p>
                <v-btn  large color="green darken-4" style="font-size: 18px" @click.stop="saveEmail(theEmail)" class="mx-0">{{customData.buttontext}}</v-btn>
              </v-form>
              </v-flex>
            </div>
          </section>
          ...
          <section id="two" class="wrapper style2">
            <header>
              <h2 >{{customData.pictureblocktitle}}</h2>
              <p >{{customData.pictureblockdescription}}</p>
            </header>
            <div class="content">
              <div class="gallery">
                <div>
  ...
  export default {
    ...
    dataContract: {
      ...
      description: {
          name:'Description',
          type: String,
          default: 'a Forest Theme'
      },
      subtitle: {
          name:'Subtitle',
          type: String,
          default: 'Fringilla Fermentum Tellus'
      },
      subheader: {
          name:'Subheader',
          type: String,
          default: 'VEHICULA URNA SED JUSTO BIBENDUM'
      },
      emailheader: {
          name:'Email Header',
          type: String,
          default: 'Sign up for 10% coupon on your next visit!'
      },
      buttontext: {
          name:'Button Text',
          type: String,
      ...
      pictureblocktitle: {
          name:'Picture Block Title',
          type: String,
          default: 'Vestibulum Convallis'
      },
      pictureblockdescription: {
          name:'Picture Block Description',
          type: String,
          default: 'VEHICULA URNA SED JUSTO BIBENDUM'
      },
      photo1title: {
          name:'Photo 1 Title',
          type: String,
          default: 'Viverra Hendrerit'
      },
      photo1text: {
          name:'Photo 1 Text',
          type: String,
          default: 'Curabitur eget semper ante. Morbi eleifend ultricies est, a blandit diam vehicula vel. Vestibulum porttitor nisi quis viverra hendrerit. Suspendisse vel volutpat nibh, vel elementum lacus. Maecenas commodo pulvinar dui, at cursus metus imperdiet.'
      },
      photo2title: {
          name:'Photo 2 Title',
          type: String,
          default: 'Curabitur Eget'
      },
      photo2text: {
          name:'Photo 2 Text',
          type: String,
