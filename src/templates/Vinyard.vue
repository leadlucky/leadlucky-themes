...
<style lang="scss" scoped>
  ...
  $ImageFilter: brightness(0.8) contrast(0.7);

  //colors
  $ColorPrimary: #bf9139;
  $ColorSecondary: #6f615a;
  $ColorText: #757575;
  $ColorWhite: #FFFFFF;
  $ColorBlack: #000000;

  //images
  $ImageBanner: "http://studentweb.cdm.depaul.edu/~tbrew/personal-projects/leadlucky-res/wine/wine-vinyard.jpg";
  $Image1: "http://studentweb.cdm.depaul.edu/~tbrew/personal-projects/leadlucky-res/wine/wine-cheers.jpg";
  $Image2: "http://studentweb.cdm.depaul.edu/~tbrew/personal-projects/leadlucky-res/wine/wine-plate.jpg";
  $Image3: "http://studentweb.cdm.depaul.edu/~tbrew/personal-projects/leadlucky-res/wine/wine-yummer.jpg";
  $Image4: "";
  $Image5: "";
  $Image6: "";
